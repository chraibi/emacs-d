...
;;(load "setup-lsp")
;; (defun load-setup-lsp-for-specific-modes ()
;;   "Load setup-lsp for specific major modes."
;;   (when (or (derived-mode-p 'python-mode)
;;             (derived-mode-p 'rust-mode)
;;             (derived-mode-p 'c++-mode))
;;     (load "setup-lsp")))

;; (eval-after-load "setup-lsp"
;;   '(progn
;;      (add-hook 'python-mode-hook #'load-setup-lsp-for-specific-modes)
;;      (add-hook 'rust-mode-hook #'load-setup-lsp-for-specific-modes)
;;      (add-hook 'c++-mode-hook #'load-setup-lsp-for-specific-modes)))
